...
ok, html, reason = fetch_archive_html('https://www.architecturaldigest.com/v2/offers/arda01029?source=SITE_0_HCL_ARD_MAGSUBHOME_0_CAMPAIGN_ROTATION_2024_ZZ')
print(extract_prices_with_context(html))
